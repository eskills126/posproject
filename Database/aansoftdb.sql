...
CREATE TABLE `customertbl` (
  ...
  `CusCreditLimit` int(50) NOT NULL,
  `CusOpenBal` int(50) NOT NULL,
  `CusAreaName` int(50) NOT NULL,
...
(124, 'yes', 'i', '8', 7, 6, 2, 1, 2),
(125, 'yahoo', 'i', '8', 7, 6, 1, 1, 2),
(126, 'Yahoo2', 'asdlkj', '9', 8, 7, 1, 1, 2),
(127, 'lkasjfd', 'sldkj', '8', 67, 6, 2, 1, 2),
(128, 'yahoo3', 'askldj', '9', 8, 7, 2, 1, 2),
(129, 'kahal', 'i', '8', 7, 6, 2, 1, 2),
(130, 'kamal', 'u', '8', 7, 6, 2, 1, 2),
(131, 'naeem', 'i', '9', 8, 7, 2, 1, 2),
(132, 'Hos', 'ui', '8', 7, 6, 2, 1, 2),
(133, 'Reh', 'slkj', '8', 9, 8, 2, 1, 2),
(134, 'adf', 'lskj', '9', 8, 7, 2, 1, 2),
(135, 'raja', 'iu', '8', 9, 7, 2, 1, 2),
(136, 'khawaja', '89', '8', 7, 6, 2, 1, 2),
(137, 'Rehman', 'skfj', '8', 7, 6, 1, 1, 2),
(138, 'Javed', 'sldfkj', '8', 9, 78, 2, 1, 2),
(139, 'Amjad', 'sldfj', '9', 8, 7, 2, 1, 2),
(140, 'kashif', 'i', '9', 8, 7, 2, 1, 2),
(141, 'Kala', 'slkj', '9', 8, 7, 2, 1, 2),
(142, 'alsdfj', 'sdlkfj', '8', 9, 8, 2, 1, 2),
(143, 'Yes', 'sdlkfj', '9', 8, 7, 2, 1, 2),
(144, 'kjad', 'slakdj', '0', 9, 8, 1, 1, 2),
(145, 'klhads', 'ksdjff', '9', 8, 7, 1, 1, 2);
...
--
ALTER TABLE `customertbl`
  MODIFY `CusId` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=146;
...
--
ALTER TABLE `salareatbl`
  MODIFY `SalAreaId` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
ALTER TABLE `customertbl`
  ...
  ADD CONSTRAINT `customertbl_ibfk_2` FOREIGN KEY (`CusAreaName`) REFERENCES `salareatbl` (`SalAreaId`);
