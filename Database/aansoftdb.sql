...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 27, 2018 at 06:11 PM
...
CREATE TABLE `customertbl` (
  ...
  `CusOpenDr` int(50) NOT NULL,
  `CusOpenCr` int(50) NOT NULL,
...
INSERT INTO `customertbl` (`CusId`, `CusName`, `CusAddress`, `CusContact`, `CusCreditLimit`, `CusOpenDr`, `CusOpenCr`, `CusAreaName`, `CusAccType`, `CusAssetType`) VALUES
(1, 'Cash Sales', 'Vehari', '0900', 900, 0, 0, 1, 1, 2),
(2, 'xyz', 'Multan', '0800', 800, 0, 0, 1, 1, 2);
...
--
ALTER TABLE `customertbl`
  MODIFY `CusId` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
