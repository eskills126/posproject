...
<!-------------------------Form elements------------------------------------>    
        ...
        <label for="customer_id">ID:</label>
      	...
      	<div class="col-75">
        <input type="text" id="uid" name="uid" class="form-control" value="" readonly="" required>
      	</div>
    	</div>
		</div>
        ...
        <label for="uom">UOM Name:</label>
      	...
      	<div class="col-75">
        <input type="text" id="uom" name="uom" placeholder="Enter Item UOM Name" required>
      	</div>
    	</div>
		</div>
...
$(document).on("click",".edit",function(){
		...
		var uid = row.closest("tr").find("td:eq(0)").text();
			$("#uid").val(uid);
