...
<div class="container-fluid">
	...
	<div class="col-xs-6 col-sm-8 col-md-offset-4">
		<h2 class="page-header text-center"><i class="fa fa-edit"></i>&nbsp Stock Transfer Transaction</h2>
		</div>
...
<!--------------------------------------------------------------------------------------------------->
    ...
    <div class="form-group">
    	<div class="row">
      	<div class="col-25">
        <label for="wid">From Warehouse:</label>
      	</div>
      	<div class="col-25"><span class="asterisk_input"></span>
        <input type="text" id="wid" name="wid" placeholder="Enter Warehouse Code" required ">
    ...
    <div class="form-group">
      <div class="row">
        <div class="col-25">
        <label for="wid1">To Warehouse:</label>
        </div>
        <div class="col-25"><span class="asterisk_input"></span>
        <input type="text" id="wid1" name="wid1" placeholder="Enter Warehouse Code" required ">
        <span id="error_scode" class="text-danger"></span>
        </div>
        <div class="col-25" style="width:0.5%;"></div>
        <div class="col-60">
        <input type="text"id="wname1" name="wname1" placeholder="Warehouse Name"style="width: 95%;" readonly>
        <span id="error_sname" class="text-danger"></span>
        <a href="warehouse.php"><i class="fa fa-plus" aria-hidden="true"></i></a>
        </div>
        </div>
