...
<!--	<div class="row"> -->
	...
	<div class="col-xs-6 col-sm-8 col-md-offset-4">
		<h2 class="page-header text-center"><i class="fa fa-edit"></i>Asset Account</h2>
		</div>
...
<div class="container">
  <form id="sfrm">
    	...
    	<div class="row">
      	<div class="col-25">
        <label for="atitle">Asset Title:</label>
      	</div>
      	<div class="col-75">
        <input type="text" id="atitle" name="atitle" placeholder="Enter Asset Name">
      	</div>
    	</div>
		</div>
        ...
        <label for="aaddress">Address:</label>
      	...
      	<div class="col-75">
        <input type="text" id="aaddress" name="aaddress" placeholder="Enter Address of Asset">
      	</div>
    	</div>
		</div>
        ...
        <label for="acontact">Contact:</label>
      	...
      	<div class="col-75">
        <input type="text" id="acontact" name="acontac" placeholder="Enter Contact of Asset">
      	</div>
    	</div>
		</div>
    	...
    	<div class="row">
      	<div class="col-25">
        <label for="aopbal">Opening Balance:</label>
      	</div>
      	<div class="col-75">
        <input type="number" id="aopbal" name="aopbal" placeholder="Enter Opening Balance">
      	</div>
    	</div>
		</div>
