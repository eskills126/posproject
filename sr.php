...
<div class="container-fluid">
	...
	<div class="col-xs-6 col-sm-8 col-md-offset-4">
		<h2 class="page-header text-center"><i class="fa fa-edit"></i>&nbsp Sales Return</h2>
		</div>
...
<!--------------------------------------------------------------------------------------------------->
    ...
    <div class="form-group">
        ...
        <label for="ccode">Customer Code:</label>
      	...
      	<div class="col-25"><span class="asterisk_input"></span>
        <input type="text" id="ccode" name="ccode" placeholder="Enter Customer Code" required ">
        <span id="error_scode" class="text-danger"></span>
      	</div>
      	<div class="col-25" style="width:0.5%;"></div>
      	<div class="col-60">
      	<input type="text"id="cname" name="cname" placeholder="Customer Name"style="width: 95%;" readonly>
        ...
        <a href="customer.php"><i class="fa fa-plus" aria-hidden="true"></i></a>
      	...
      	<label for="cbal">Balance:</label>
      	</div>
      	<div class="col-25">
      	<input type="text" name="cbal" id="cbal" placeholder="Customer Balance"style="width:80%;" readonly>
      ...
      <!---Quantity row----->
    	...
    	<div class="row">
      	<div class="col-25">
        <label for="rrate">Return Rate:</label>
      	</div>
      	<div class="col-25"><span class="asterisk_input"></span>
        <input type="number" id="rrate" name="rrate" placeholder="Return Rate" required>
        ...
        <label for="remarks">Remarks:</label>
      	...
      	<div class="col-75">
        <input type="number" id="remarks" name="remarks" placeholder="Remarks..." style="width:107%;" required>
...
<br>
     <!---Totoal----->
      ...
      <div class="row">
        <div class="col-25">
        <label for="tqty">Total:</label>
        </div>
        <div class="col-25">
        <input type="number" id="tqty" name="tqty" placeholder="Total Quantity" required>
        <span id="error_gamount" class="text-danger"></span>
        </div>
        <div class="col-25" style="width:0.5%;"></div>
      <div class="col-25">
        ...
        <div class="col-25">
        <input type="number" id="bamount" name="bamount" required style="border:2px solid #ccc; border-radius: 4px;height: 35px;" placeholder="Bill Amount">
        <span id="error_disrate" class="text-danger"></span>
        </div>
        </div>
      </div>
