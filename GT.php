 ...
 <div class="form-group">
      ...
      <div class="row">
        ...
        <label for="abal">Current Balance:</label>
      	...
      	<div class="col-25">
        <input type="number" id="abal" name="abal" required style="border:2px solid #ccc; border-radius: 4px;height: 35px;background-color:#edf1f7;" placeholder="Current Balance"readonly>
