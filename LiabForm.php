...
<!--	<div class="row"> -->
	...
	<div class="col-xs-6 col-sm-8 col-md-offset-4">
		<h2 class="page-header text-center"><i class="fa fa-edit"></i>Liabilities/Payables</h2>
		</div>
...
<div class="container">
  <form id="sfrm">
    	...
    	<div class="row">
      	<div class="col-25">
        <label for="ltitle">Liability Title:</label>
      	</div>
      	<div class="col-75">
        <input type="text" id="ltitle" name="ltitle" placeholder="Enter Liability Name">
      	</div>
    	</div>
		</div>
        ...
        <label for="laddress">Address:</label>
      	...
      	<div class="col-75">
        <input type="text" id="laddress" name="laddress" placeholder="Enter Address of Liability">
      	</div>
    	</div>
		</div>
        ...
        <label for="lcontact">Contact:</label>
      	...
      	<div class="col-75">
        <input type="text" id="lcontact" name="lcontac" placeholder="Enter Contact">
      	</div>
    	</div>
		</div>
    	...
    	<div class="row">
      	<div class="col-25">
        <label for="lopbal">Opening Balance:</label>
      	</div>
      	<div class="col-75">
        <input type="number" id="lopbal" name="lopbal" placeholder="Enter Opening Balance">
      	</div>
    	</div>
		</div>
